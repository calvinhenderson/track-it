defmodule TrackIt.DataCase do
  ...
  by setting `use TrackIt.DataCase, async: true`, although
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import TrackIt.DataCase
    end
  end

  setup tags do
    TrackIt.DataCase.setup_sandbox(tags)
    :ok
  end
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(TrackIt.Repo, shared: not tags[:async])
